...
LETTERS = {
    'β (Бета)': 0,
    'γ (Гамма)': 1996041966,   # Ирина Матвеева
    'δ (Дельта)': 438057772,   # Олеся Ивановна Ольшевская
    'ε (Эпсилон)': 421885070,  # Аля
    'ζ (Дзета)': 671488345,    # Крупитченко Наталья
    ...
    'τ (Тау)': 16,
    'φ (Фи)': 1698307304,      # Роман Генадьевич
...
HOLIDAYS = ['01.09', '23.02', '06.03', '07.03', '08.03', '01.05', '02.05', '09.05', '10.05']
# Осенние каникулы
HOLIDAYS += ['31.10', '01.11', '02.11', '03.11', '04.11', '05.11', '06.11', '04.11', '05.11', '06.11']
# Новый год, конечно
